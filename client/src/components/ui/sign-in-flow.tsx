...
> {
  ...
  componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
    console.warn("Canvas error (WebGL may not be supported):", error);
  }
...
export const SignInFlow = ({ className, onSuccess }: SignInPageProps) => {
                ...
                {step === "email" ? (
                  ...
                  >
                    ...
                    <div className="space-y-4">
                      <a 
                        href="/api/login" 
                        className="backdrop-blur-[2px] w-full flex items-center justify-center gap-2 bg-gradient-to-r from-violet-500/20 to-fuchsia-500/20 hover:from-violet-500/30 hover:to-fuchsia-500/30 text-white border border-violet-500/30 rounded-full py-3 px-4 transition-all duration-300"
